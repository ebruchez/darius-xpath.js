...
import client.net.sf.saxon.ce.expr.{Binding, VariableReference, XPathContext}
import client.net.sf.saxon.ce.functions.{ConstructorFunctionLibrary, FunctionLibrary, FunctionLibraryList}
import client.net.sf.saxon.ce.om.{NamespaceResolver, StructuredQName}
import client.net.sf.saxon.ce.orbeon
import client.net.sf.saxon.ce.sxpath.AbstractStaticContext
import client.net.sf.saxon.ce.trans.XPathException
import client.net.sf.saxon.ce.value.{QNameValue, SequenceType}
