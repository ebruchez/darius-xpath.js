...
class REMatcher(program: REProgram) {
   ...
   * @see REProgram
   */
  def setProgram(program: REProgram) {
   ...
   */
  protected def setParenStart(which: Int, i: Int) {
   ...
   * @param i     Index in input array
   */
  protected def setParenEnd(which: Int, i: Int) {
   ...
   */
  protected def internalError(s: String) {
