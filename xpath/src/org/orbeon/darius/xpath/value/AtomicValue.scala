...
import org.orbeon.darius.xpath.`type`.{AtomicType, ConversionResult, Type}
...
import org.orbeon.darius.xpath.tree.iter.{SingletonIterator, UnfailingIterator}
...
abstract class AtomicValue extends Item with ConversionResult {
   ...
   *                  [[org.orbeon.darius.xpath.functions.Component]], for example [[org.orbeon.darius.xpath.functions.Component.HOURS]]
