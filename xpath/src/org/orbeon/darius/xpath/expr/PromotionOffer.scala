...
import org.orbeon.darius.xpath.expr.PromotionOffer._
import org.orbeon.darius.xpath.expr.sort.DocumentSorter
import org.orbeon.darius.xpath.functions.Reverse
import org.orbeon.darius.xpath.lib.NamespaceConstant
import org.orbeon.darius.xpath.om.StructuredQName
import org.orbeon.darius.xpath.value.{Cardinality, SequenceType}
