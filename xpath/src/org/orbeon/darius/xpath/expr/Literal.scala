...
import org.orbeon.darius.xpath.om.{Item, NodeInfo, Sequence, SequenceIterator}
 ...
 * interface as a wrapper around a [[org.orbeon.darius.xpath.value.SequenceTool]]. This may derive from an actual literal in an XPath expression
