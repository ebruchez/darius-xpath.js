...
import org.orbeon.darius.xpath.expr.ValueComparison._
import org.orbeon.darius.xpath.expr.sort.{AtomicComparer, CodepointCollator, GenericAtomicComparer}
import org.orbeon.darius.xpath.functions.{Count, SystemFunction}
...
object ValueComparison {
   ...
   * @param op       the operator, as defined by constants such as [[org.orbeon.darius.xpath.expr.Token.FEQ]] or
   *                 [[org.orbeon.darius.xpath.expr.Token.FLT]]
