...
import org.orbeon.darius.xpath.tree.linked.ParentNodeImpl._
...
abstract class ParentNodeImpl extends NodeImpl {
   ...
   * [[org.orbeon.darius.xpath.tree.linked.NodeImpl]]. It will be modified as a result of this call (by setting its
